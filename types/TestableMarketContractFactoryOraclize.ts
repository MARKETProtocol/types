...
export class TestableMarketContractFactoryOraclize extends TypeChainContract {
  ...
  ): Promise<TestableMarketContractFactoryOraclize> {
    const contract = new TestableMarketContractFactoryOraclize(web3, address);

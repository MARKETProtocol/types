...
export class UpgradeableTokenMock extends TypeChainContract {
  ...
  public constructor(web3: any, address: string | BigNumber) {
    const abi = [
      ...
      {
        inputs: [{ name: 'previousTokenAddress', type: 'address' }],
        payable: false,
        stateMutability: 'nonpayable',
        type: 'constructor'
      },
  ...
  ): Promise<UpgradeableTokenMock> {
    const contract = new UpgradeableTokenMock(web3, address);
  ...
  public get PREVIOUS_TOKEN_ADDRESS(): Promise<string> {
    return promisify(this.rawWeb3Contract.PREVIOUS_TOKEN_ADDRESS, []);
  }
